...
export default function WhatsappButton() {
  ...
  return (
    ...
    >
      <span
        className={`glass mr-3 hidden whitespace-nowrap rounded-full px-4 py-2 font-sans text-sm font-medium text-ink-100 shadow-glass transition-all duration-300 sm:block ${
          tip
