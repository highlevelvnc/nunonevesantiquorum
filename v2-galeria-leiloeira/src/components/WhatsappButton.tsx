...
export default function WhatsappButton() {
  ...
  return (
    ...
    >
      <span
        className={`mr-3 hidden whitespace-nowrap rounded-full bg-ink-900 px-4 py-2 font-sans text-xs uppercase tracking-wide2 text-ivory-100 shadow-[0_14px_34px_-16px_rgba(20,18,16,0.7)] transition-all duration-300 sm:block ${
          tip
      ...
      <span className="relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-[0_10px_30px_-6px_rgba(37,211,102,0.7)] ring-2 ring-white transition-transform duration-300 hover:scale-110">
